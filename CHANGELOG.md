...
## [2.29.0](https://github.com/Ikalus1988/MisakaNet/compare/v2.28.1...v2.29.0) (2026-09-10)
...
* **dsh:** make MisakaNet installable as a compliant DSH plugin bundle ([d29509b](https://github.com/Ikalus1988/MisakaNet/commit/d29509bfa7407343bfb0ba2feca311648e912917))
...
* **lessons:** add DSH plugin install codeload-timeout lesson (from [#1418](https://github.com/Ikalus1988/MisakaNet/issues/1418)) ([19e31c0](https://github.com/Ikalus1988/MisakaNet/commit/19e31c0d5f62a6a92d3097bf4180dff8a2902b9f))
* **lessons:** add WebCrypto fallback consistency lesson ([#1398](https://github.com/Ikalus1988/MisakaNet/issues/1398)) ([96981af](https://github.com/Ikalus1988/MisakaNet/commit/96981af922d20c5692b254826da013a17e25c86f))
...
* **lessons:** mcporter Cloudflare OAuth — correct endpoint, no scope, WSL callback trap ([58d94e5](https://github.com/Ikalus1988/MisakaNet/commit/58d94e5d6b8605258010cd55a0b7af3777624610))
...
* **benchmark+security:** command extraction quality + drop eval/exec false positives ([056ef9e](https://github.com/Ikalus1988/MisakaNet/commit/056ef9e86bc1fc02325eabe847574bca06a90549))
* **ci:** add mcp domain to docs/domains to fix Agent Auditor test failures ([b163456](https://github.com/Ikalus1988/MisakaNet/commit/b163456e56cda2b56b54a6b79fadc523d65a78f5))
...
* **ci:** exclude _archive/ from Lesson Security Scan to reduce false positives ([ec0a1b9](https://github.com/Ikalus1988/MisakaNet/commit/ec0a1b927521de2e3f8fe8adb0b52944a601db32))
...
* **fatal-guard:** fix Windows compatibility issues ([3a1da01](https://github.com/Ikalus1988/MisakaNet/commit/3a1da01661a5c7147bb4871991c7773d2dabd532))
...
* **workers:** ensure crypto fallback and verify agent onboarding ([#1258](https://github.com/Ikalus1988/MisakaNet/issues/1258)) ([#1383](https://github.com/Ikalus1988/MisakaNet/issues/1383)) ([801f23c](https://github.com/Ikalus1988/MisakaNet/commit/801f23cdf354d8140709806a032d23abecc486db))


### Documentation

* add dsh plugin installation guide ([098d681](https://github.com/Ikalus1988/MisakaNet/commit/098d681899850f617b50e8c745b1f44c333eee2b))
* add dsh plugin installation guide ([95e1d2a](https://github.com/Ikalus1988/MisakaNet/commit/95e1d2afed0f3e150741e0dd5608ac42efa719b6))
* add dsh plugin installation guide ([c7a83b8](https://github.com/Ikalus1988/MisakaNet/commit/c7a83b8376f360b5b11062d488b662a13f005e96))
* Add dsh plugin installation guide ([0dca645](https://github.com/Ikalus1988/MisakaNet/commit/0dca645d8c5c90896a11843c94a0dbbc01e0fe3b)), closes [#1402](https://github.com/Ikalus1988/MisakaNet/issues/1402)
...
* **journey:** surface HTTP MCP search + intake in the newcomer journey ([c68c3e9](https://github.com/Ikalus1988/MisakaNet/commit/c68c3e9bbc48ce7fb3551150c08e42a102007636))
...
* **readme:** add dsh-plugin.org listing badge ([272e99b](https://github.com/Ikalus1988/MisakaNet/commit/272e99bc8b7f671cc0256201892963a6c3070144))
...
* **readme:** recommend npm install for DSH plugin (misakanet@2.23.0) ([e7fcc27](https://github.com/Ikalus1988/MisakaNet/commit/e7fcc27555884830c413656cc5476c4bb4fdafd2))
* **readme:** reorganize badges by category (Core/Install/Ecosystem) like major repos ([c0d83c4](https://github.com/Ikalus1988/MisakaNet/commit/c0d83c4f5af5733f7b3398c45e39e60df24430e6))
* **readme:** replace stale ASCII architecture with Mermaid diagram ([207ee10](https://github.com/Ikalus1988/MisakaNet/commit/207ee1023b841cab808c9c4456c6e4d8795ce44e))
...
* refresh llms.txt — 317 lessons, 7 MCP tools, remote endpoint ([25e7e8c](https://github.com/Ikalus1988/MisakaNet/commit/25e7e8cef41d825196edd56ce9762da3eb695f50))
...
* **release-checklist:** note server.mcpb removed, server.json is the manifest ([c30652b](https://github.com/Ikalus1988/MisakaNet/commit/c30652be6beaaa3fecd0ddea24018d7990ca14aa))
...
* **absorb:** remove stale test for archived absorb_journey_reports script (slim pass missed it, breaking PR audit gate) ([03d4062](https://github.com/Ikalus1988/MisakaNet/commit/03d4062ef45f47c251015cbe7b7f6358bcb0699d))
